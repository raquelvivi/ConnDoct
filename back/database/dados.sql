otimo agora por fim pode criar varios inserts para cada tabela? tipo uns vinte para que eu possa testar o back? 
use o banco de dados a baixo como molde. A tabela OBS se refere a problemas adicionais dos pacientes 
tipo: diabetes, cancer, altismo, sindrome de dal ... ,resposta: nivel 1, nivel 2, nenhum..., 
a coluna acesso da tabela pessoa se refere a permição do paciente sobre a amostra dos seus dados 
pelos medicos portanto so pode ser false ou true, seja criativo nas respostas. 
